...
def build_animated_ascii_svg(lines, output_path="profile-ascii.svg"):
    ...
    num_rows = len(lines)
    max_cols = max(len(l) for l in lines) if lines else 72
    ...
    # Extended 4.5 second typing duration for smooth, satisfying typing effect
    total_duration = 4.5
    ...
    svg_parts.append('''
        ...
        .line-typing {
            opacity: 0;
            animation: typeWipe 0.3s cubic-bezier(0.2, 0.8, 0.4, 1) forwards;
        }
